  ...
  modeloOrganico: {
    ...
    gruposVPD: [{
      ...
      subgrupos: [{
        ...
        vpds: [{
          codigo: "3.1.1.1.00.00.00",
          descricao: "Vencimentos e Salários",
          valorCP: 25000000.00,
          valorSIC: 25000000.00
        }, {
          codigo: "3.1.1.2.00.00.00",
          descricao: "Gratificações",
          valorCP: 8000000.00,
          valorSIC: 7950000.00
        }, {
          codigo: "3.1.1.3.00.00.00",
        ...
        totalSIC: 5240514.20,
        vpds: [{
          codigo: "3.1.2.1.00.00.00",
          descricao: "INSS Patronal",
          valorCP: 3500000.00,
          valorSIC: 3500000.00
        }, {
          codigo: "3.1.2.2.00.00.00",
          descricao: "FGTS",
          valorCP: 1740514.20,
          valorSIC: 1740514.20
        }]
        ...
        totalSIC: 2500000.00,
        vpds: [{
          codigo: "3.1.3.1.00.00.00",
          descricao: "Vale Alimentação",
          valorCP: 1500000.00,
          valorSIC: 1500000.00
        }, {
          codigo: "3.1.3.2.00.00.00",
        ...
        totalSIC: 2504000.00,
        vpds: [{
          codigo: "3.1.8.1.00.00.00",
          descricao: "Outros Custos de Pessoal",
          valorCP: 2504000.00,
          valorSIC: 2504000.00
        }]
      }]
      ...
      subgrupos: [{
        ...
        totalSIC: 1500000.00,
        vpds: [{
          codigo: "3.2.1.1.00.00.00",
          descricao: "Aposentadorias",
          valorCP: 1200000.00,
          valorSIC: 1200000.00
        }, {
          codigo: "3.2.1.2.00.00.00",
          descricao: "Reformas",
          valorCP: 300000.00,
          valorSIC: 300000.00
        }]
        ...
        totalSIC: 800000.00,
        vpds: [{
          codigo: "3.2.2.1.00.00.00",
          descricao: "Pensões por Morte",
          valorCP: 800000.00,
          valorSIC: 800000.00
        }]
      }, {
        ...
        totalSIC: 300000.00,
        vpds: [{
          codigo: "3.2.3.1.00.00.00",
          descricao: "BPC Idoso",
          valorCP: 200000.00,
          valorSIC: 200000.00
        }, {
          codigo: "3.2.3.2.00.00.00",
          descricao: "BPC Deficiente",
          valorCP: 100000.00,
          valorSIC: 100000.00
        }]
      }, {
      ...
      subgrupos: [{
        ...
        totalSIC: 2500000.00,
        vpds: [{
          codigo: "3.3.1.1.00.00.00",
          descricao: "Material de Escritório",
          valorCP: 500000.00,
          valorSIC: 500000.00
        }, {
          codigo: "3.3.1.2.00.00.00",
          descricao: "Material de Limpeza",
          valorCP: 800000.00,
          valorSIC: 800000.00
        }, {
          codigo: "3.3.1.3.00.00.00",
          descricao: "Material de Informática",
          valorCP: 1200000.00,
          valorSIC: 1200000.00
        }]
      }, {
        ...
        totalSIC: 8050000.00,
        vpds: [{
          codigo: "3.3.2.1.00.00.00",
          descricao: "Serviços de Terceiros - PJ",
          valorCP: 5000000.00,
          valorSIC: 5000000.00
        }, {
          codigo: "3.3.2.2.00.00.00",
          descricao: "Serviços de Terceiros - PF",
          valorCP: 2000000.00,
          valorSIC: 2050000.00
        }, {
          codigo: "3.3.2.3.00.00.00",
          descricao: "Serviços de Utilidade Pública",
          valorCP: 1000000.00,
          valorSIC: 1000000.00
        }]
      }, {
        ...
        totalSIC: 3124617.94,
        vpds: [{
          codigo: "3.3.3.1.00.00.00",
          descricao: "Depreciação de Bens Móveis",
          valorCP: 2000000.00,
          valorSIC: 2000000.00
        }, {
          codigo: "3.3.3.2.00.00.00",
          descricao: "Depreciação de Bens Imóveis",
          valorCP: 1124617.94,
          valorSIC: 1124617.94
        }]
      }, {
      ...
      subgrupos: [{
        ...
        totalSIC: 1000000.00,
        vpds: [{
          codigo: "3.7.1.1.00.00.00",
          descricao: "IPTU",
          valorCP: 600000.00,
          valorSIC: 600000.00
        }, {
          codigo: "3.7.1.2.00.00.00",
        ...
        totalSIC: 300000.00,
        vpds: [{
          codigo: "3.7.8.1.00.00.00",
          descricao: "Outros Custos Tributários",
          valorCP: 300000.00,
          valorSIC: 300000.00
        }]
      }]
      ...
      subgrupos: [{
        ...
        totalSIC: 400000.00,
        vpds: [{
          codigo: "3.9.1.1.00.00.00",
          descricao: "Prêmios Diversos",
          valorCP: 400000.00,
          valorSIC: 400000.00
        }]
      }, {
        ...
        totalSIC: 600000.00,
        vpds: [{
          codigo: "3.9.4.1.00.00.00",
          descricao: "Incentivos Fiscais",
          valorCP: 600000.00,
          valorSIC: 600000.00
        }]
      }, {
        ...
        totalSIC: 800000.00,
        vpds: [{
          codigo: "3.9.7.1.00.00.00",
          descricao: "Provisões Diversas",
          valorCP: 800000.00,
          valorSIC: 800000.00
        }]
      }, {
...
export default function ComparacaoVPDs() {
  ...
  const renderTreeNode = (node: TreeNode): React.ReactNode => {
    ...
    return <div key={node.id} className="w-full">
        <div className={cn("flex items-start gap-1.5 sm:gap-2 p-2 sm:p-3 rounded-lg cursor-pointer transition-all duration-200 hover:bg-muted/30", node.isEquipment && "bg-blue-500/10 border border-blue-500/20")} style={{
        paddingLeft: `${Math.min((node.level - 1) * 12, 36)}px`
      }}>
          ...
          toggleModalNode(node.id);
            ...
            </button> : <div className="w-4 sm:w-5 flex-shrink-0" />}
          
          {node.icon && <div className="flex-shrink-0 mt-0.5">
          ...
          <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4">
            <div className="flex-1 min-w-0">
              {node.code && <div className="text-[10px] sm:text-xs font-mono text-muted-foreground bg-muted/20 px-1.5 py-0.5 rounded inline-block mb-1">
                  {node.code}
                </div>}
              <div className={cn("text-xs sm:text-sm font-medium leading-snug", node.isEquipment && "text-blue-600 dark:text-blue-400")}>
                {node.name}
              </div>
            </div>
        ...
        {hasChildren && isExpanded && <div className="mt-0.5">
  ...
  const temDivergencia = (vpd: number, total: number) => {
    const {
      diferenca
    } = calcularDiferenca(vpd, total);
    return diferenca > 0.01;
  };
  const subgrupoTemDivergencia = (subgrupo: VPDSubGroup) => {
    return hasDivergence(subgrupo.totalCP, subgrupo.totalSIC) || subgrupo.vpds.some(vpd => hasDivergence(vpd.valorCP, vpd.valorSIC));
  };
  const subgrupoTemDivergenciaInterna = (subgrupo: VPDSubGroup) => {
    return !hasDivergence(subgrupo.totalCP, subgrupo.totalSIC) && subgrupo.vpds.some(vpd => hasDivergence(vpd.valorCP, vpd.valorSIC));
  };
  const grupoTemDivergencia = (grupo: VPDGroup) => {
    return hasDivergence(grupo.totalCP, grupo.totalSIC) || grupo.subgrupos.some(sub => subgrupoTemDivergencia(sub));
  };
  ...
  return <div className="min-h-screen bg-background p-6">
        ...
        {!selectedRecord ? <Card>
            ...
            <CardContent>
              <Table>
                ...
                return <TableRow key={record.id} className="cursor-pointer hover:bg-muted/50" onClick={() => setSelectedRecord(record)}>
                        <TableCell className="font-medium">{record.mes}/{record.ano}</TableCell>
                        <TableCell>
                          <Badge variant={record.status === "aprovado" ? "default" : "secondary"} className={`flex items-center gap-1 ${record.status === "aprovado" ? "bg-green-600" : "bg-amber-500"}`}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            {divOrganic && <Badge variant="outline" className="border-amber-500 text-amber-700 dark:text-amber-400 flex items-center gap-1">
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            {divProg && <Badge variant="outline" className="border-amber-500 text-amber-700 dark:text-amber-400 flex items-center gap-1">
                                <CircleAlert className="h-3 w-3" />
                                Divergente
                              </Badge>}
                          </div>
            ...
            <div className="flex items-center justify-between">
              ...
              {selectedRecord.status === "pendente" && <Button onClick={() => handleAprovar(selectedRecord.id)}>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {temDivergencia(selectedRecord.modeloOrganico.totalVPDs, selectedRecord.modeloOrganico.totalSIC) ? <Badge variant="destructive" className="flex items-center gap-2 animate-pulse">
                        <XCircle className="h-4 w-4" />
                        Divergente
                      </Badge> : <Badge variant="default" className="flex items-center gap-2 bg-green-600">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4 border-r pr-6">
                      ...
                      <div className="space-y-2">
                        ...
                        const {
                          ...
                          subgruposSemDiv,
                          vpdsSemDiv
                        } = contarItensSemDivergencia(selectedRecord.modeloOrganico.gruposVPD);
                        const totalItensOk = gruposSemDiv + subgruposSemDiv + vpdsSemDiv;
                        if (totalItensOk > 0) {
                          return <Badge variant="outline" className="border-green-500 text-green-700 dark:text-green-400 flex items-center gap-1.5">
                        ...
                        {selectedRecord.modeloOrganico.gruposVPD.filter(grupo => grupoTemDivergencia(grupo)).map(grupo => <Collapsible key={`organico-cp-${grupo.codigoPrincipal}`} open={expandedGroups.has(`organico-cp-${grupo.codigoPrincipal}`)}>
                            <div className="border rounded-lg overflow-hidden">
                              <CollapsibleTrigger onClick={() => toggleGroup(`organico-cp-${grupo.codigoPrincipal}`)} className="w-full p-3 flex items-center justify-between hover:bg-accent/50 transition-colors bg-yellow-50 dark:bg-yellow-950/30">
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="flex flex-col items-end gap-1">
                                    ...
                                    {hasDivergence(grupo.totalCP, grupo.totalSIC) ? <div className="flex items-center gap-1">
                                      ...
                                      </div> : grupoTemDivergenciaInterna(grupo) && <div className="flex items-center gap-1">
                                        <Badge variant="outline" className="text-[9px] py-0 h-3.5 border-amber-500 text-amber-700 dark:text-amber-400">
                                          Dif: {formatCurrency(calcularDivergenciaInternaGrupo(grupo))}
                                        </Badge>
                                      </div>}
                                  </div>
                                  {expandedGroups.has(`organico-cp-${grupo.codigoPrincipal}`) ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                                </div>
                              </CollapsibleTrigger>
                              <CollapsibleContent>
                                <div className="px-3 pb-3 pt-1 space-y-2">
                                  {grupo.subgrupos.filter(sub => subgrupoTemDivergencia(sub)).map(subgrupo => <Collapsible key={`organico-cp-sub-${subgrupo.codigo}`} open={expandedSubGroups.has(`organico-cp-sub-${subgrupo.codigo}`)}>
                                      <div className="border rounded-lg overflow-hidden">
                                        <CollapsibleTrigger onClick={() => toggleSubGroup(`organico-cp-sub-${subgrupo.codigo}`)} className="w-full p-2 flex items-center justify-between hover:bg-accent/50 transition-colors bg-orange-50 dark:bg-orange-950/20">
                                          <div className="flex flex-col items-start flex-1">
                                          ...
                                          <div className="flex items-center gap-2">
                                            <div className="flex flex-col items-end gap-0.5">
                                              ...
                                              {hasDivergence(subgrupo.totalCP, subgrupo.totalSIC) ? <Badge variant="outline" className="text-[9px] py-0 h-3.5 border-amber-500 text-amber-700 dark:text-amber-400">
                                                  Dif: {formatCurrency(Math.abs(subgrupo.totalCP - subgrupo.totalSIC))}
                                                </Badge> : subgrupoTemDivergenciaInterna(subgrupo) && <Badge variant="outline" className="text-[9px] py-0 h-3.5 border-amber-500 text-amber-700 dark:text-amber-400">
                                                  Dif: {formatCurrency(calcularDivergenciaInternaSubgrupo(subgrupo))}
                                                </Badge>}
                                            </div>
                                            {expandedSubGroups.has(`organico-cp-sub-${subgrupo.codigo}`) ? <ChevronDown className="h-3 w-3" /> : <ChevronRight className="h-3 w-3" />}
                                          </div>
                                        </CollapsibleTrigger>
                                        <CollapsibleContent>
                                          <div className="px-2 pb-2 pt-1">
                                            <Table>
                                              ...
                                              <TableBody>
                                                {subgrupo.vpds.filter(vpd => hasDivergence(vpd.valorCP, vpd.valorSIC)).map(vpd => <TableRow key={vpd.codigo} className={`${hasDivergence(vpd.valorCP, vpd.valorSIC) ? 'bg-red-50 dark:bg-red-950/20' : 'bg-background'}`}>
                                                    <TableCell className="text-xs py-2 font-mono">
                                                      <div className="flex items-center gap-1">
                                                        {vpd.codigo}
                                                        {hasDivergence(vpd.valorCP, vpd.valorSIC) && <AlertTriangle className="h-3 w-3 text-destructive" />}
                                                      </div>
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="text-center py-2">
                                                      <Button variant="ghost" size="sm" className="h-6 w-6 p-0" onClick={() => openVPDDetail(vpd)}>
                    ...
                    <div className="space-y-4 pl-6">
                      ...
                      <div className="space-y-2">
                        ...
                        {selectedRecord.modeloOrganico.gruposVPD.filter(grupo => grupoTemDivergencia(grupo)).map(grupo => <Collapsible key={`organico-sic-${grupo.codigoPrincipal}`} open={expandedGroups.has(`organico-sic-${grupo.codigoPrincipal}`)}>
                            <div className="border rounded-lg overflow-hidden">
                              <CollapsibleTrigger onClick={() => toggleGroup(`organico-sic-${grupo.codigoPrincipal}`)} className="w-full p-3 flex items-center justify-between hover:bg-accent/50 transition-colors bg-yellow-50 dark:bg-yellow-950/30">
                                <div className="flex flex-col items-start flex-1">
                                  <span className="text-xs font-mono text-muted-foreground">{grupo.codigoPrincipal}</span>
                                  <span className="text-sm font-medium">{grupo.descricao}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {expandedGroups.has(`organico-sic-${grupo.codigoPrincipal}`) ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                                </div>
                              </CollapsibleTrigger>
                              <CollapsibleContent>
                                <div className="px-3 pb-3 pt-1 space-y-2">
                                  {grupo.subgrupos.filter(sub => subgrupoTemDivergencia(sub)).map(subgrupo => <Collapsible key={`organico-sic-sub-${subgrupo.codigo}`} open={expandedSubGroups.has(`organico-sic-sub-${subgrupo.codigo}`)}>
                                      <div className="border rounded-lg overflow-hidden">
                                        <CollapsibleTrigger onClick={() => toggleSubGroup(`organico-sic-sub-${subgrupo.codigo}`)} className="w-full p-2 flex items-center justify-between hover:bg-accent/50 transition-colors bg-orange-50 dark:bg-orange-950/20">
                                          <div className="flex flex-col items-start flex-1">
                                            <span className="text-xs font-mono text-muted-foreground">{subgrupo.codigo}</span>
                                            <span className="text-xs font-medium">{subgrupo.descricao}</span>
                                          </div>
                                          <div className="flex items-center gap-2">
                                            ...
                                            {expandedSubGroups.has(`organico-sic-sub-${subgrupo.codigo}`) ? <ChevronDown className="h-3 w-3" /> : <ChevronRight className="h-3 w-3" />}
                                          </div>
                                        </CollapsibleTrigger>
                                        <CollapsibleContent>
                                          <div className="px-2 pb-2 pt-1">
                                            <Table>
                                              ...
                                              <TableBody>
                                                {subgrupo.vpds.filter(vpd => hasDivergence(vpd.valorCP, vpd.valorSIC)).map(vpd => <TableRow key={vpd.codigo} className={`${hasDivergence(vpd.valorCP, vpd.valorSIC) ? 'bg-red-50 dark:bg-red-950/20 border-l-4 border-l-destructive' : 'bg-background'}`}>
                                                    <TableCell className="text-xs py-2 font-mono">
                                                      <div className="flex items-center gap-1">
                                                        {vpd.codigo}
                                                        {hasDivergence(vpd.valorCP, vpd.valorSIC) && <AlertTriangle className="h-3 w-3 text-destructive animate-pulse" />}
                                                      </div>
                                                    </TableCell>
                                                    <TableCell className="text-xs py-2">
                                                      <div className="flex items-center gap-2">
                                                        <span>{vpd.descricao}</span>
                                                        {hasDivergence(vpd.valorCP, vpd.valorSIC) && <Badge variant="outline" className="text-[10px] py-0 h-4 border-amber-500 text-amber-700 dark:text-amber-400 flex items-center gap-0.5">
                                                            SIC ≠ CP
                                                          </Badge>}
                                                      </div>
                                                    </TableCell>
                                                    <TableCell className="text-right text-xs py-2 font-semibold">
                                                      <div className="flex flex-col items-end gap-0.5">
                                                        ...
                                                        {hasDivergence(vpd.valorCP, vpd.valorSIC) && <span className="text-[10px] text-muted-foreground font-normal">
                  ...
                  {/* Resumo de Diferença */}
                   {temDivergencia(selectedRecord.modeloOrganico.totalVPDs, selectedRecord.modeloOrganico.totalSIC) && <div className="mt-6 p-4 bg-destructive/10 border-2 border-destructive/30 rounded-lg animate-fade-in">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {temDivergencia(selectedRecord.modeloProgramatico.totalVPDs, selectedRecord.modeloProgramatico.totalSIC) ? <Badge variant="destructive" className="flex items-center gap-2 animate-pulse">
                        <XCircle className="h-4 w-4" />
                        Divergente
                      </Badge> : <Badge variant="default" className="flex items-center gap-2 bg-green-600">
                        <CheckCircle className="h-4 w-4" />
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4 border-r pr-6">
                      ...
                      <div className="space-y-2">
                        ...
                        const {
                          ...
                          subgruposSemDiv,
                          vpdsSemDiv
                        } = contarItensSemDivergencia(selectedRecord.modeloProgramatico.gruposVPD);
                        const totalItensOk = gruposSemDiv + subgruposSemDiv + vpdsSemDiv;
                        if (totalItensOk > 0) {
                          return <Badge variant="outline" className="border-green-500 text-green-700 dark:text-green-400 flex items-center gap-1.5">
                                  <CheckCircle className="h-3 w-3" />
                        ...
                        {selectedRecord.modeloProgramatico.gruposVPD.filter(grupo => grupoTemDivergencia(grupo)).map(grupo => <Collapsible key={`programatico-cp-${grupo.codigoPrincipal}`} open={expandedGroups.has(`programatico-cp-${grupo.codigoPrincipal}`)}>
                            <div className="border rounded-lg overflow-hidden">
                              <CollapsibleTrigger onClick={() => toggleGroup(`programatico-cp-${grupo.codigoPrincipal}`)} className="w-full p-3 flex items-center justify-between hover:bg-accent/50 transition-colors bg-yellow-50 dark:bg-yellow-950/30">
                                <div className="flex flex-col items-start flex-1">
                                  <span className="text-xs font-mono text-muted-foreground">{grupo.codigoPrincipal}</span>
                                  <span className="text-sm font-medium">{grupo.descricao}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {expandedGroups.has(`programatico-cp-${grupo.codigoPrincipal}`) ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                                </div>
                              </CollapsibleTrigger>
                              <CollapsibleContent>
                                <div className="px-3 pb-3 pt-1 space-y-2">
                                  {grupo.subgrupos.filter(sub => subgrupoTemDivergencia(sub)).map(subgrupo => <Collapsible key={`programatico-cp-sub-${subgrupo.codigo}`} open={expandedSubGroups.has(`programatico-cp-sub-${subgrupo.codigo}`)}>
                                      <div className="border rounded-lg overflow-hidden">
                                        <CollapsibleTrigger onClick={() => toggleSubGroup(`programatico-cp-sub-${subgrupo.codigo}`)} className="w-full p-2 flex items-center justify-between hover:bg-accent/50 transition-colors bg-orange-50 dark:bg-orange-950/20">
                                          <div className="flex flex-col items-start flex-1">
                                            <span className="text-xs font-mono text-muted-foreground">{subgrupo.codigo}</span>
                                            <span className="text-xs font-medium">{subgrupo.descricao}</span>
                                          </div>
                                          <div className="flex items-center gap-2">
                                            ...
                                            {expandedSubGroups.has(`programatico-cp-sub-${subgrupo.codigo}`) ? <ChevronDown className="h-3 w-3" /> : <ChevronRight className="h-3 w-3" />}
                                          </div>
                                        </CollapsibleTrigger>
                                        <CollapsibleContent>
                                          <div className="px-2 pb-2 pt-1">
                                              ...
                                              <TableBody>
                                                {subgrupo.vpds.filter(vpd => hasDivergence(vpd.valorCP, vpd.valorSIC)).map(vpd => <TableRow key={vpd.codigo} className={`${hasDivergence(vpd.valorCP, vpd.valorSIC) ? 'bg-red-50 dark:bg-red-950/20 border-l-4 border-l-destructive' : 'bg-background'}`}>
                                                    <TableCell className="text-xs py-2 font-mono">
                                                       <div className="flex items-center gap-1">
                                                         {vpd.codigo}
                                                          {hasDivergence(vpd.valorCP, vpd.valorSIC) && <div className="relative">
                                                    ...
                                                    <TableCell className="text-xs py-2">
                                                      <div className="flex items-center gap-2">
                                                        <span>{vpd.descricao}</span>
                                                        {hasDivergence(vpd.valorCP, vpd.valorSIC) && <Badge variant="outline" className="text-[10px] py-0 h-4 border-amber-500 text-amber-700 dark:text-amber-400 flex items-center gap-0.5">
                                                            {vpd.valorSIC > vpd.valorCP ? <TrendingUp className="h-2.5 w-2.5" /> : vpd.valorSIC < vpd.valorCP ? <TrendingDown className="h-2.5 w-2.5" /> : <Minus className="h-2.5 w-2.5" />}
                                                            SIC ≠ CP
                                                          </Badge>}
                                                      </div>
                                                    </TableCell>
                    ...
                    <div className="space-y-4 pl-6">
                      ...
                      <div className="space-y-2">
                        ...
                        {selectedRecord.modeloProgramatico.gruposVPD.filter(grupo => grupoTemDivergencia(grupo)).map(grupo => <Collapsible key={`programatico-sic-${grupo.codigoPrincipal}`} open={expandedGroups.has(`programatico-sic-${grupo.codigoPrincipal}`)}>
                            <div className="border rounded-lg overflow-hidden">
                              <CollapsibleTrigger onClick={() => toggleGroup(`programatico-sic-${grupo.codigoPrincipal}`)} className="w-full p-3 flex items-center justify-between hover:bg-accent/50 transition-colors bg-yellow-50 dark:bg-yellow-950/30">
                                <div className="flex flex-col items-start flex-1">
                                  <span className="text-xs font-mono text-muted-foreground">{grupo.codigoPrincipal}</span>
                                  <span className="text-sm font-medium">{grupo.descricao}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {expandedGroups.has(`programatico-sic-${grupo.codigoPrincipal}`) ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                                </div>
                              </CollapsibleTrigger>
                              <CollapsibleContent>
                                <div className="px-3 pb-3 pt-1 space-y-2">
                                  {grupo.subgrupos.filter(sub => subgrupoTemDivergencia(sub)).map(subgrupo => <Collapsible key={`programatico-sic-sub-${subgrupo.codigo}`} open={expandedSubGroups.has(`programatico-sic-sub-${subgrupo.codigo}`)}>
                                      <div className="border rounded-lg overflow-hidden">
                                        <CollapsibleTrigger onClick={() => toggleSubGroup(`programatico-sic-sub-${subgrupo.codigo}`)} className="w-full p-2 flex items-center justify-between hover:bg-accent/50 transition-colors bg-orange-50 dark:bg-orange-950/20">
                                          <div className="flex flex-col items-start flex-1">
                                            <span className="text-xs font-mono text-muted-foreground">{subgrupo.codigo}</span>
                                            <span className="text-xs font-medium">{subgrupo.descricao}</span>
                                          </div>
                                          <div className="flex items-center gap-2">
                                            ...
                                            {expandedSubGroups.has(`programatico-sic-sub-${subgrupo.codigo}`) ? <ChevronDown className="h-3 w-3" /> : <ChevronRight className="h-3 w-3" />}
                                          </div>
                                        </CollapsibleTrigger>
                                        <CollapsibleContent>
                                          <div className="px-2 pb-2 pt-1">
                                                    ...
                                                    <TableCell className="text-xs py-2">
                                                     ...
                                                     <TableCell className="text-right text-xs py-2 font-semibold">
                                                       <div className="flex flex-col items-end gap-0.5">
                                                         ...
                                                         {hasDivergence(vpd.valorCP, vpd.valorSIC) && <div className="flex items-center gap-1 text-destructive">
                  ...
                  {/* Resumo de Diferença */}
                   {temDivergencia(selectedRecord.modeloProgramatico.totalVPDs, selectedRecord.modeloProgramatico.totalSIC) && <div className="mt-6 p-4 bg-destructive/10 border-2 border-destructive/30 rounded-lg animate-fade-in">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="p-1.5 rounded-full bg-destructive/20">
                          <AlertTriangle className="h-5 w-5 text-destructive" />
                        </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedVPD && <div className="flex flex-col gap-1 mt-2">
                  ...
                  <div className="flex gap-4 mt-2">
                    ...
                    {hasDivergence(selectedVPD.valorCP, selectedVPD.valorSIC) && <Badge variant="destructive" className="text-xs">
          ...
          {selectedVPD && <AnalyticalGrid selectedNodeName={selectedVPD.descricao} selectedNodeLevel={4} />}
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-auto">
            <Table>
              ...
              <TableBody>
                {registrosPendentes.map(registro => <TableRow key={registro.id}>
                    <TableCell>
                      <Badge variant="secondary" className={cn("text-xs", registro.tipo === "EP" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300" : "bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300")}>
                        {registro.tipo}
                      </Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <Badge variant="outline" className={cn("text-[10px]", registro.status === "em_analise" ? "border-yellow-500 text-yellow-700 dark:text-yellow-400" : "border-orange-500 text-orange-700 dark:text-orange-400")}>
                        {registro.status === "em_analise" ? "Em Análise" : "Pendente"}
                      </Badge>
                    </TableCell>
                    <TableCell className="text-right">
                      <Button variant="outline" size="sm" className="gap-1.5" onClick={() => handleAbrirAjuste(registro)}>
      ...
      <Dialog open={isAjusteModalOpen} onOpenChange={setIsAjusteModalOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              {registroEmEdicao?.tipo === "EP" ? <Building2 className="h-5 w-5 text-blue-500" /> : <FileText className="h-5 w-5 text-purple-500" />}
          ...
          {registroEmEdicao && <div className="space-y-4">
              <div className="p-3 bg-muted/50 rounded-lg space-y-2">
                ...
                {registroEmEdicao.valor > 0 && <div className="flex items-center justify-between">
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <Input id="descricao" defaultValue={registroEmEdicao.descricao} placeholder="Descrição do registro" />
                </div>
